...
import com.imooc.video.dao.VideoDao;
import com.imooc.video.domain.*;
import com.imooc.video.domain.exception.ConditionException;
import com.imooc.video.service.util.FastDFSUtil;
import com.imooc.video.service.util.ImageUtil;
import com.imooc.video.service.util.IpUtil;
...
public class VideoService {
    ...
    public List<VideoBinaryPicture> convertVideoToImage(Long videoId, String fileMd5) throws Exception{
        com.imooc.video.domain.File file = fileService.getFileByMd5(fileMd5);
